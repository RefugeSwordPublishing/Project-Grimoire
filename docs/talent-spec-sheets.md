...
### Weapon and Tool Quality
All assembled weapons and tools have five quality levels. Quality is determined at the **Workbench** during Assembly.

| Tier | Color | How Achieved |
|------|-------|-------------|
| Crude | Grey | Base components, any assembler level |
| Rough | White | Base components + assembler Talent 20+ |
| Refined | Green | Base components + Rare material added at Assembly |
| Pristine | Blue | Base components + Rare material + assembler Talent 60+ |
...
**Active Attunement:** Choose which plant to harvest when multiples appear, picking the rarer option yields higher quality level
...
| 24 | Rough quality yields possible on Attunement | Better reagent grade |
...
| 63 | Refined quality yields possible on Attunement | Requires Alchemy 50 to use |
...
| 87 | Pristine quality yields possible on Attunement | Master-grade reagents |
...
| Level | Unlock | Notes |
|-------|--------|-------|
| 1 | Rabbit Snare | Crude Pelt; Cookery meat |
...
**Active Attunement:** Water, prune, or treat plants when prompt appears, boosts yield quantity and quality level
