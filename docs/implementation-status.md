...
- **Not yet:** active-play inputs / attunement bonuses (the tap window), zone-boss spawns (active-only), Slaying-talent elite bonus, sprites/animations (`OnPlayerAttack`/`OnEnemyAttack` are wired hooks).
